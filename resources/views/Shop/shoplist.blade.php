            ...
            <div class="acod-content collapse" id="collapseExample">
                ...
                <div class="widget widget_services">
                    ...
                    <div class="form-check search-content">
                        ...
                        <a href="{{ route('shop', ['category' => $categories->slug]) }}" class="form-check-label">
                            {{$categories->title}}
                        </a>
                    </div>
                        ...
                        <div class="dz-content">
                            ...
                            <div class="dz-body">
                                <div class="dz-rating-box">
                                    <div>
                                        <p class="dz-para" id="text" style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">{!! $products->description !!}</p>
                                        <!-- <div>
                                ...
                                <div class="rate">
                                    <ul class="book-info">
                                        ...
                                        <li><span>Publisher</span>{{$products->publisher}}</li>
                                    ...
                                    <div class="d-flex">
                                        <div style="margin-right: 8px;">
                                            <form id="add-to-cart-form" action="/product/cart/{{$products->id}}" method="post">
                                                ...
                                                <button type="submit" class="btn btn-secondary box-btn btnhover btnhover2"><i class="fas fa-shopping-cart m-r10"></i> Add to cart</button>
                                            </form>
                                        </div>
                                        <div>
                                            <form action="/wishlist/{{$products->id}}" method="post">
                                                ...
                                                <button type="submit" style="background-color:white; border-radius:4px; padding:8px; border-color:grey ; ">
                                                    ...
                                                    <i class="fas fa-heart" style="padding: 6px;"></i>
